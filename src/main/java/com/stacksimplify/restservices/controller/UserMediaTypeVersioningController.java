...
@GetMapping(value =  "/{id}", produces="application/vnd.stacksimplify.app-v1+json")public UserDtoV1 getUserById(@PathVariable @Min(1) Long userid ) throws UserNotFoundException {
